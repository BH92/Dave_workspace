...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PDM_BCCU" URI="http://resources/4.1.8/app/PDM_BCCU/0" description="PDM_BCCU APP configures the Channel registers &#xA;of the Brightness and Color Control Unit (BCCU)." mode="NOTSHARABLE" version="4.1.8" minDaveVersion="4.0.0" instanceLabel="PDM_BCCU_0" appLabel="">
  <upwardMapList xsi:type="ResourceModel:RequiredApp" href="../../PDM_DIMMED_LED_LAMP/v4_0_4/PDM_DIMMED_LED_LAMP_0.app#//@requiredApps.2"/>
  ...
  <virtualSignals name="pdm_output_pin" URI="http://resources/4.1.8/app/PDM_BCCU/0/vs_pdmbccu_pad" hwSignal="pad" hwResource="//@hwResources.1" visible="true"/>
  <virtualSignals name="dimming_level_input" URI="http://resources/4.1.8/app/PDM_BCCU/0/vs_pdmbccu_dimin" hwSignal="dimin" hwResource="//@hwResources.0" visible="true">
    ...
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../DIM_BCCU/v4_1_6/DIM_BCCU_0.app#//@connections.0"/>
  </virtualSignals>
  ...
  <hwResources name="BCCUChannel" URI="http://resources/4.1.8/app/PDM_BCCU/0/hwres_bccu" resourceGroupUri="peripheral/bccu/*/channel/*" mResGrpUri="peripheral/bccu/*/channel/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/BCCU0/BCCU0_0.dd#//@provided.12"/>
  </hwResources>
  <hwResources name="PDM Output pin" URI="http://resources/4.1.8/app/PDM_BCCU/0/hwres_io" resourceGroupUri="port/p/*/pad/*" mResGrpUri="port/p/*/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/Port1/Port1_1.dd#//@provided.0"/>
  </hwResources>
  <hwResources name="PDM Output pin" URI="http://resources/4.1.8/app/PDM_BCCU/0/__pin_hwres_io" resourceGroupUri="devicepackage/0/14" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.0"/>
  </hwResources>
  <connections URI="http://resources/4.1.8/app/PDM_BCCU/0/http://resources/4.1.8/app/PDM_BCCU/0/vs_pdmbccu_out/http://resources/4.1.8/app/PDM_BCCU/0/vs_pdmbccu_pad" systemDefined="true" sourceSignal="pdm_output" targetSignal="pdm_output_pin" srcVirtualSignal="//@virtualSignals.0" targetVirtualSignal="//@virtualSignals.1"/>
